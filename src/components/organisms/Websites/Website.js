	...
	return (
		<Wrapper>
			...
			<ContentWrapper ref={contentRef}>
				...
				<ListsContainer>
					<ListsWrapper>
						{lang === 'en' && <ListTitle>Technologies</ListTitle>}
						{lang === 'pl' && <ListTitle>Technologie</ListTitle>}
						<List>{techList}</List>
					</ListsWrapper>
					<ListsWrapper>
						{lang === 'en' && <ListTitle>Scope of work</ListTitle>}
						{lang === 'pl' && <ListTitle>Zakres prac</ListTitle>}
